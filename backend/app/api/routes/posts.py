...
from app.core.deps import get_current_user, get_db, require_csrf, require_moderator, require_verified_user
...
async def create_post(
    ...
    post = Post(**payload.model_dump(), content=sanitize_markdown(payload.content), user_id=current_user.id)
    db.add(post)
    await db.commit()
